 ...
 * @LastEditTime: 2026-09-08 17:28:39
 * @Description: module 的常量
 * @FilePath: /nest-lab/packages/rag-hub-backend-2/src/document/document-status.ts
 */
/**
 * 文档状态与流转规则
 *
...
export function canEditContent(status: DocumentStatus): boolean {
  return status === DocumentStatus.Draft || status === DocumentStatus.Published || status === DocumentStatus.Archived
}
